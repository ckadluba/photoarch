...
class TestFileAnalyzer(unittest.TestCase):
    ...
    def test_analyze_file_real_image(self):
        ...
        self.assertEqual(info.keywords[0], "beer")
        self.assertEqual(info.keywords[1], "bottle")
        self.assertEqual(info.keywords[2], "next")
        self.assertEqual(info.keywords[3], "sandwich")
        self.assertEqual(info.keywords[4], "sitting")
        self.assertEqual(info.keywords[5], "table")
        self.assertEqual(info.keywords_german[0], "Bier")
        self.assertEqual(info.keywords_german[1], "Flasche")
        self.assertEqual(info.keywords_german[2], "neben")
        self.assertEqual(info.keywords_german[3], "Sandwich")
        self.assertEqual(info.keywords_german[4], "steht")
        self.assertEqual(info.keywords_german[5], "Tisch")
